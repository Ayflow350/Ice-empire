  ...
  return (
    <div className="relative min-h-screen w-full bg-black overflow-hidden font-sans text-white selection:bg-cyan-500/30">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute top-[20%] right-[-10%] w-[40vw] h-[40vw] bg-cyan-900/10 blur-[100px] rounded-full animate-pulse"></div>
        <div className="absolute bottom-[-10%] left-[-10%] w-[40vw] h-[40vw] bg-blue-900/10 blur-[100px] rounded-full animate-pulse delay-700"></div>
      ...
      <main className="relative z-10 container mx-auto px-6 py-12 md:py-20">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          <div className="w-full lg:w-1/2">
            <div className="mb-10">
              <h1 className="text-4xl md:text-5xl font-black uppercase tracking-tighter text-transparent bg-clip-text bg-gradient-to-br from-white to-gray-500 mb-4">
            ...
            <form className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-[10px] uppercase tracking-[0.2em] text-cyan-400 font-bold">
                    Name
                  </label>
                  <div className="relative group">
                    <input
                      type="text"
                      className="w-full bg-white/5 border border-white/10 rounded-lg py-3 px-4 text-sm text-white focus:outline-none focus:border-cyan-500 focus:bg-cyan-900/10 transition-all duration-300"
                      placeholder="ENTER NAME"
                    />
                    <div className="absolute inset-0 border border-cyan-500/0 group-hover:border-white/20 pointer-events-none rounded-lg transition-colors"></div>
                  </div>
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] uppercase tracking-[0.2em] text-cyan-400 font-bold">
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <select className="w-full bg-white/5 border border-white/10 rounded-lg py-3 px-4 text-sm text-gray-300 focus:outline-none focus:border-cyan-500 focus:bg-cyan-900/10 transition-all duration-300 appearance-none">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  rows={5}
                  className="w-full bg-white/5 border border-white/10 rounded-lg py-3 px-4 text-sm text-white focus:outline-none focus:border-cyan-500 focus:bg-cyan-900/10 transition-all duration-300 resize-none"
              ...
              <button
                type="button"
                className="group relative w-full overflow-hidden bg-white text-black rounded-lg py-4 transition-all hover:bg-cyan-400"
              >
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="space-y-4">
              {faqs.map((faq, index) => (
                ...
                >
                  ...
                  >
                    <div className="p-6 pt-0 text-sm text-gray-400 font-light leading-relaxed border-t border-dashed border-white/10 mt-2">
                      {faq.answer}
                    </div>
                  </div>
                </div>
            ...
            <div className="mt-12 p-8 border border-white/10 rounded-2xl bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] relative overflow-hidden group">
              <div className="absolute inset-0 bg-cyan-900/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              ...
              <button className="relative z-10 text-xs font-bold text-cyan-400 uppercase tracking-widest border-b border-cyan-400 pb-1 hover:text-white hover:border-white transition-all">
      ...
      <div className="fixed bottom-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-cyan-900 to-transparent opacity-50"></div>
    </div>
  );
};
