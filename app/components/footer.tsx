    ...
    <footer className="bg-neutral-900 text-neutral-300 border-t border-neutral-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
            ...
            <div className="flex space-x-4">
              ...
              >
                ...
                <svg
                  ...
                  aria-hidden="true"
                >
                  <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93v6.16c0 2.52-1.12 4.84-2.91 6.37-1.79 1.53-4.22 2.38-6.66 2.32-4.82-.03-8.8-3.95-8.8-8.77S2.2 5.4 7.02 5.37c.47-.01.94.05 1.4.13v4.26c-.22-.03-.45-.06-.68-.06-2.45 0-4.44 2-4.44 4.46s1.99 4.46 4.44 4.46c2.25 0 4.18-1.69 4.43-3.91V.02h.35z" />
                </svg>
              </a>
            </div>
          </div>
          ...
          {/* Shop Links */}
          <div>
            <h4 className="text-white font-medium mb-4">Collections</h4>
          ...
          <div>
            ...
            <form className="flex flex-col space-y-2">
              <input
                ...
                className="bg-neutral-800 border border-neutral-700 text-white px-4 py-2 rounded focus:outline-none focus:ring-1 focus:ring-white text-sm"
              />
              <button className="bg-white text-black font-medium px-4 py-2 rounded text-sm hover:bg-neutral-200 transition-colors">
                Subscribe
              </button>
            </form>
          </div>
